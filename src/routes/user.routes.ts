...
class UsersRoutes{
    ...
    getRoutes() {
        ...
        this.router.put('/', this.usersController.recover.bind(this.usersController))
        this.router.put('/edit', this.authMiddleware.auth,this.usersController.update.bind(this.usersController))
